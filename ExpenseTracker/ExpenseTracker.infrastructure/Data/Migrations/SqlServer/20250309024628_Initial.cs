        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxFileSize = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurrenceFrequency", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expense_Category_CategoryEntityId",
                        column: x => x.CategoryEntityId,
                        principalTable: "Category",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expense_RecurrenceFrequency_RecurrenceFrequencyId",
                        column: x => x.RecurrenceFrequencyId,
                        principalTable: "RecurrenceFrequency",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseEntityId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachment_Expense_ExpenseEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachment_ExpenseEntityId",
                table: "Attachment",
                column: "ExpenseEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Expense_CategoryEntityId",
                table: "Expense",
                column: "CategoryEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Expense_RecurrenceFrequencyId",
                table: "Expense",
